# Ongoing issue surrounding the get_lyrics_* functionalities
# https://github.com/ewenme/geniusr/issues/17
# Patch implemented by @morosophist on github until the issue is fixed.
#
#
#
